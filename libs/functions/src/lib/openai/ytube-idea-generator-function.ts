...
const generateYTubeIdea  = (req: any, res: Response) => {
    cors(req,res, async() => {
        const { youtubeIdea, tone, variants, creativityLevel, language  } = req.body;
        if(!req.body) {
