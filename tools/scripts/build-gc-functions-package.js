...
const packageJson = require('../../apps/andika-functions/package.json'); // Take root package.json
const fs = require('fs');
...
const path = 'dist/apps/andika-functions/package.json'; // Where to save generated package.json file
